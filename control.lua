...
eventMgr.subscribe("on_load", OnLoad)
eventMgr.subscribe("on_configuration_changed", OnConfigChanged)

eventMgr.subscribe("on_built_entity", OnBuilt)
eventMgr.subscribe("on_robot_built_entity", OnBuilt)
eventMgr.subscribe("on_tick", OnTick)

eventMgr.subscribe("on_player_mined_entity", OnRemoved)
eventMgr.subscribe("on_robot_mined_entity", OnRemoved)
eventMgr.subscribe("on_entity_died", OnRemoved)

eventMgr.subscribe("heli-up", OnHeliUp)
eventMgr.subscribe("heli-down", OnHeliDown)
eventMgr.subscribe("heli-zaa-height-increase", OnHeliIncreaseMaxHeight)
eventMgr.subscribe("heli-zab-height-decrease", OnHeliDecreaseMaxHeight)
eventMgr.subscribe("heli-zba-toogle-floodlight", OnHeliToggleFloodlight)
eventMgr.subscribe("heli-zca-remote-heli-follow", OnHeliFollow)
eventMgr.subscribe("heli-zcb-remote-open", OnRemoteOpen)


eventMgr.subscribe("on_player_placed_equipment", OnPlacedEquipment)
eventMgr.subscribe("on_player_removed_equipment", OnRemovedEquipment)
eventMgr.subscribe("on_gui_click", OnGuiClick)
eventMgr.subscribe("on_gui_text_changed", OnGuiTextChanged)

eventMgr.subscribe("on_player_changed_force", OnPlayerChangedForce)
eventMgr.subscribe("on_player_died", OnPlayerDied)
eventMgr.subscribe("on_player_left_game", OnPlayerLeft)
eventMgr.subscribe("on_player_respawned", OnPlayerRespawned)
eventMgr.subscribe("on_player_joined_game", OnPlayerJoined)
eventMgr.subscribe("on_player_created", OnPlayerCreated)

eventMgr.subscribe("on_player_armor_inventory_changed", OnArmorInventoryChanged)
eventMgr.subscribe("on_player_driving_changed_state", OnDrivingStateChanged)

eventMgr.subscribe("on_runtime_mod_setting_changed", OnRuntimeSettingsChanged)